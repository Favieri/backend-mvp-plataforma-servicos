...
public interface IProfessionalServiceRepository
{
    ...
    Task<object> CreateAsync(string professionalId, string serviceId, string nomeServico, decimal preco, string? descricao, int? tierId, string? contractMode, int? durationMinutes, int? minLeadTimeMinutes, CancellationToken ct);
